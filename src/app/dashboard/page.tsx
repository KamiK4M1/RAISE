      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-3 py-3 flex items-center justify-between">
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="relative flex-shrink-0">
                ...
                <Brain className="relative h-7 w-7 sm:h-8 sm:w-8 text-white bg-gradient-to-r from-blue-600 to-purple-600 p-1.5 rounded-xl" />
              </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <span className="hidden sm:inline text-gray-600 text-sm lg:text-base">สวัสดี, {String(user?.name) || 'นักเรียน'}</span>
              <span className="sm:hidden text-gray-600 text-xs truncate max-w-[80px]">{String(user?.name) || 'นักเรียน'}</span>
              <Button
                onClick={handleLogoutClick}
                variant="outline"
                className="bg-white text-gray-700 border-gray-300 hover:bg-gray-50 text-xs sm:text-sm px-2 sm:px-4 py-1.5 sm:py-2"
              >
        ...
        <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6 lg:py-8">
              ...
              <CardContent className="p-3 sm:p-4 lg:p-6">
                <div className="flex items-center justify-between">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 truncate">{stats.documentsUploaded}</p>
                  </div>
              ...
              <CardContent className="p-3 sm:p-4 lg:p-6">
                <div className="flex items-center justify-between">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 truncate">{stats.flashcardsStudied}</p>
                  </div>
              ...
              <CardContent className="p-3 sm:p-4 lg:p-6">
                <div className="flex items-center justify-between">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 truncate">{stats.quizzesTaken}</p>
                  </div>
              ...
              <CardContent className="p-3 sm:p-4 lg:p-6">
                <div className="flex items-center justify-between">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 truncate">{stats.totalStudyTime}</p>
                  </div>
          ...
          <div className="grid xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="xl:col-span-2 space-y-4 sm:space-y-6">
              ...
              <Card className="border-0 shadow-sm">
                ...
                <CardContent className="pt-0">
                  <div className="grid gap-3 sm:gap-4">
                    {/* Upload Document - Full width on mobile */}
                    ...
                    {/* Flashcards - Full width on mobile and tablets */}
                    <Card className="border border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all cursor-pointer bg-gradient-to-br from-purple-50 to-indigo-50">
                    ...
                    {/* Other tools - 2 columns on larger screens */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                      ...
                      <Link href="/reports" className="sm:col-span-2 lg:col-span-1">
              ...
              <Card className="border-0 shadow-sm">
                <CardHeader className="pb-3 sm:pb-4">
                  <CardTitle className="text-lg sm:text-xl">กิจกรรมล่าสุด</CardTitle>
                </CardHeader>
                <CardContent>
                      ...
                      recentActivities.map((activity, index) => {
                        ...
                        return (
                          <div key={index} className="flex items-center space-x-3 py-2">
                            <div className={`w-2 h-2 ${getIconColorClass(String(activity.icon_color) || 'blue')} rounded-full flex-shrink-0`}></div>
                            <span className="text-sm flex-1 min-w-0 truncate">{String(activity.title)}</span>
                            <span className="text-xs text-gray-500 flex-shrink-0">{String(activity.relative_time)}</span>
                          </div>
                        )
                      })
                    ) : (
              ...
              <Card className="border-0 shadow-sm">
                <CardHeader className="pb-3 sm:pb-4">
                  <CardTitle className="text-lg sm:text-xl">เอกสารล่าสุด</CardTitle>
                </CardHeader>
                <CardContent>
                        ...
                        <div key={document.document_id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                          ...
                          <div className="flex items-center space-x-1 sm:space-x-2 flex-shrink-0">
                            <Link href={`/documents/${document.document_id}`}>
                              <Button variant="ghost" size="sm" className="text-blue-600 hover:text-blue-800 p-1 sm:p-2">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              {/* Mobile Forgetting Curve Preview */}
        ...
        <Dialog open={showLogoutDialog} onOpenChange={setShowLogoutDialog}>
          <DialogContent className="mx-4 max-w-md">
            <DialogHeader>
              <DialogTitle className="text-lg">ออกจากระบบ</DialogTitle>
