      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:flex items-center space-x-4">
                <span className="text-gray-600">สวัสดี, {String(user?.name) || "นักเรียน"}</span>
                <Button
            ...
            {mobileMenuOpen && (
              <div className="md:hidden border-t bg-white py-4">
                <div className="flex flex-col space-y-4">
                  <div className="px-4 py-2 text-gray-600">สวัสดี, {String(user?.name) || "นักเรียน"}</div>
                  <div className="px-4">
                    <Button
                      onClick={handleLogoutClick}
                      variant="outline"
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 text-sm sm:text-base">ติดตามความก้าวหน้าและเข้าถึงเครื่องมือการเรียนรู้ของคุณ</p>
          </div>
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-4">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-600">เอกสาร</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-4">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-600">แฟลชการ์ด</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-4">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-600">แบบทดสอบ</p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-sm hover:shadow-md transition-shadow">
              <CardContent className="p-4">
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-600">เวลาเรียน (ชม.)</p>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">เครื่องมือการเรียนรู้</h2>
            <p className="text-gray-600 text-sm mb-6">เลือกเครื่องมือที่ต้องการใช้งาน</p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-gray-900 mb-1">อัปโหลดเอกสาร</h3>
                  ...
                  <Card className="border border-gray-200 hover:border-green-300 hover:shadow-md transition-all cursor-pointer h-full">
                    <CardContent className="p-6">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          <h3 className="font-semibold text-gray-900 mb-1">แบบทดสอบ</h3>
                  ...
                  <Card className="border border-gray-200 hover:border-orange-300 hover:shadow-md transition-all cursor-pointer h-full">
                    <CardContent className="p-6">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          <h3 className="font-semibold text-gray-900 mb-1">ถาม AI</h3>
                ...
                <Card className="border border-gray-200 hover:border-pink-300 hover:shadow-md transition-all cursor-pointer">
                  <CardContent className="p-6">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-gray-900 mb-1">รายงาน</h3>
                        <p className="text-sm text-gray-600">ดูสถิติและความคืบหน้า</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          {/* Mobile Layout for Sidebar Content */}
                    ...
                    recentActivities.map((activity, index) => {
                      ...
                      return (
                        <div key={index} className="flex items-center space-x-3 py-2">
                          ...
                          ></div>
                          <span className="text-sm flex-1 min-w-0">{String(activity.title)}</span>
